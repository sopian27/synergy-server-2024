...
class IkpLapor_Model extends CI_Model
{
    ...
    public function allJenisInsiden()
    {
        return $this->db->get('sikat_jenis_insiden')->result();
    }

    public function allNamaInsiden()
    {
        return $this->db->get('sikat_nama_insiden')->result();
    }

    public function allSkorDampak()
    {
        return $this->db->get('sikat_skor_dampak')->result();
    }

    public function allTipeInsiden()
    {
        return $this->db->get('sikat_tipe_insiden')->result();
    }

    public function allSubtipeInsiden()
    {
        return $this->db->get('sikat_subtipe_insiden')->result();
    }

    public function allFrekuensiKejadian()
    {
        return $this->db->get('sikat_frekuensi_kejadian')->result();
    }

    public function allTindakanOleh()
    {
        return $this->db->get('sikat_tindakan_oleh')->result();
    }

    public function allInsiden()
    {
        return $this->db->get('insiden_keselamatan')->result();
    }
    ...
    public function allInsidenByQuery($searchStr)
    {
        $this->db
        ->select('insiden_keselamatan.*', false)
        ->from('insiden_keselamatan as insiden_keselamatan');
        if(isset($searchStr)) {
            $this->db->like('insiden_keselamatan.nama_insiden',$searchStr); 
            $this->db->or_like('insiden_keselamatan.jenis_insiden',$searchStr);
            $this->db->or_like('insiden_keselamatan.dampak',$searchStr);
        }
        $this->db->limit(10);
        return $this->db->get()->result_array();
    }
